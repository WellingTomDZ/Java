...
public class Aplicativo {
	public static void main(String[] args) {
		...
		// Instanciando o obgjeto de compra na primeira posição do array
		...
		compras.get(0).getListaDeProdutos().get(0).setId(new Long(gerador.nextInt()*100));
		...
		// Produto 02
		compras.get(0).getListaDeProdutos().add(new Produto());
		compras.get(0).getListaDeProdutos().get(1).setId(new Long(gerador.nextInt()*100));
		...
		// Produto 03
		compras.get(0).getListaDeProdutos().add(new Produto());
		compras.get(0).getListaDeProdutos().get(2).setId(new Long(gerador.nextInt()*100));
