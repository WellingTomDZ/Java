...
public class AlunoDAO extends ConnectionDAO {
	...
	// método responsavel por editar os dados do aluno no banco de dados
	...
	// método responsavel por deletar os dados do aluno no banco de dados
	public void deleteRegistro(Long id) throws SQLException {
		...
		try {
			...
			if (flag == 0)
				throw new SQLException("Erro ao deletar os dados do aluno");
